...
#ifndef WORKOUTTHUMBNAILEXTENSION_SWIFT_H
#define WORKOUTTHUMBNAILEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WorkoutThumbnailExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25WorkoutThumbnailExtension17ThumbnailProvider")
@interface ThumbnailProvider : QLThumbnailProvider
- (void)provideThumbnailForFileRequest:(QLFileThumbnailRequest * _Nonnull)request completionHandler:(void (^ _Nonnull)(QLThumbnailReply * _Nullable, NSError * _Nullable))handler;
