...
#ifndef PACE___PLATES_SWIFT_H
#define PACE___PLATES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pace___Plates",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Pace___Plates17GameCenterService")
...
@class CLLocation;
SWIFT_CLASS("_TtC13Pace___Plates10RunTracker")
@interface RunTracker : NSObject <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC13Pace___Plates16WeatherViewModel")
